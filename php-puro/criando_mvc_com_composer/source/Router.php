...
class Router
{
    ...
    /*
        ...
        uma string e uma função. E por fi?r=/usersm armazena no array de rotas, com a estrutura:
        array(2) {
            ["get"]=> array(3) {
                ["/"]=> object(Closure)#2 (0) { }
                ...
    ...
    */
    ...
    {
        // vendo se o método é get ou post app->get
        ...
        [$route, $action] = $args;
        // verificando se é uma função 2º argumento
    ...
    */
    public function run()
    {
        ...
        // se tiver r na url retorna a rota se não, retorna index
        $route = $_GET['r'] ?? '/';
